...
const App = () => {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <h1 className="font-bold mb-4 text-center text-3xl">Commit Number skdwifhdweiih3984u935</h1>
            ...
            <div className='flex justify-around w-full p-2  '>
              <div className="w-1/2 p-4 space-y-2">
                {change.filestr.map((line) => (
                  <div key={line.lineNumber} className="flex justify-between text-white">
