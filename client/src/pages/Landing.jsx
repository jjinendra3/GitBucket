    ...
    <div className=" p-8 my-4 text-center text-white flex-row justify-center items-center">
      <div className="w-1/2 mx-auto">
        ...
        <p className="text-lg mb-8">
          Your personal code space. Manage your repositories, commits, and files
          effortlessly.
        </p>
        <div>
        ...
        <div>
          ...
          <p className="text-lg mb-2">
            Jinendra Jain - Second Year Computer Science Engineering
            undergraduate at JIIT Noida.
          </p>
        ...
        <div>
          ...
          <p className="text-lg mb-4">
            We invite developers from around the world to contribute to GHB.
            Your ideas and expertise can make a significant impact. Visit our
            GitHub repository, explore the issues, or open a new one. Let's
            build together!
          </p>
